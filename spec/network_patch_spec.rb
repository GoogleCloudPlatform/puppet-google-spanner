...
describe Google::Spanner::Network::Patch do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Spanner::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Spanner::NetworkBlocker.instance.allow_put(
  ...
  context 'failed request' do
    before(:each) { Google::Spanner::NetworkBlocker.instance.deny(uri_in) }
