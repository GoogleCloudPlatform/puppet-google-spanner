...
describe Google::Spanner::Network::Delete do
  let(:credential) { TestCred.new }
  let(:uri) { Google::Spanner::NetworkBlocker::ALLOWED_TEST_URI }

  context 'verify proper request' do
    before(:each) { Google::Spanner::NetworkBlocker.instance.allow_delete(uri) }
  ...
  context 'failed request' do
    before(:each) { Google::Spanner::NetworkBlocker.instance.deny(uri) }
