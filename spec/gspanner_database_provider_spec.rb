...
describe Puppet::Type.type(:gspanner_database).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                <<-MANIFEST
                gspanner_instance { 'resource(instance,0)':
                  ensure       => present,
                ...
                gspanner_instance { 'resource(instance,1)':
                  ensure       => present,
                ...
                gspanner_instance { 'resource(instance,2)':
                  ensure       => present,
                ...
                gspanner_database { 'title0':
                  ensure           => present,
                  extra_statements => ['ww', 'xx'],
                  instance         => 'resource(instance,0)',
                  project          => 'test project#0 data',
                  credential       => 'cred0',
                }

                gspanner_database { 'title1':
                  ensure           => present,
                  extra_statements => ['uu', 'vv'],
                  instance         => 'resource(instance,1)',
                  project          => 'test project#1 data',
                  credential       => 'cred1',
                }

                gspanner_database { 'title2':
                  ensure           => present,
                  extra_statements => ['ss', 'tt'],
            ...
            context 'Gspanner_database[title0]' do
              subject do
                catalog.resource('Gspanner_database[title0]').provider
              end

              it { is_expected.to have_attributes(name: 'title0') }
              it { is_expected.to have_attributes(extra_statements: %w[ww xx]) }
            end

            context 'Gspanner_database[title1]' do
              subject do
                catalog.resource('Gspanner_database[title1]').provider
              end

              it { is_expected.to have_attributes(name: 'title1') }
              it { is_expected.to have_attributes(extra_statements: %w[uu vv]) }
            end

            context 'Gspanner_database[title2]' do
              subject do
                catalog.resource('Gspanner_database[title2]').provider
              end

              it { is_expected.to have_attributes(name: 'title2') }
              it { is_expected.to have_attributes(extra_statements: %w[ss tt]) }
            end
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gspanner_database[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gspanner_database[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gspanner_database).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  # Only used for gspanner_instance objects
  ...
  def expand_variables(template, data, extra_data = {})
    Puppet::Type.type(:gspanner_database).provider(:google)
